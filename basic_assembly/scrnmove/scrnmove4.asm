...
* 1.03 changed to wraparound all directions
*
* EXAMPLE:
*   CLEAR 200,&H3F00
*   DEFUSR0=&H3F00
...
* lwasm --decb -9 -o SCRNMOV4.bin scrnmove4.asm
* lwasm --decb -f basic -o SCRNMOV4.BAS scrnmove4.asm
* decb copy -2 -r SCRNMOV4.BAS ../Xroar/dsk/DRIVE0.DSK,SCRNMOVE4.BIN
